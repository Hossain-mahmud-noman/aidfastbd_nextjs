...
import HearingCareCenterDetails from "../../../components/hearingCareCenter/HearingCareCenterDetails";
...
export async function generateMetadata({ params }) {
  ...
  if (!data) {
    return { title: "Hearing Care Center Not Found" };
  }
  ...
  return {
    ...
    openGraph: {
      ...
      images: [profile],
      url: `${frontend_url}/hearing-care-center/${data.userId}`,
    },
  };
}
