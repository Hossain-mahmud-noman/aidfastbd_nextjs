...
import DrugDeAddictionDetails from "../../../components/drugDeAddictionDetails/DrugDeAddictionDetails";
...
export async function generateMetadata({ params }) {
  ...
  if (!data) {
    return { title: "Drug De Addiction Center Not Found" };
  }
  ...
  return {
    ...
    openGraph: {
      ...
      images: [profile],
      url: `${frontend_url}/drug-de-addiction/${data.userId}`,
    },
  };
}
