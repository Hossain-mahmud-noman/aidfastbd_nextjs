            ...
            {title ? (
              ...
              <div className="flex justify-between">
                <div className="flex flex-wrap">
                  <SearchInput
                    className="w-44 border-[1px] border-primary"
                    onChange={(e) => {
        ...
        >
          <div className="overflow-x-auto">
            <table className="table-auto w-full">
              <thead className="text-xs font-semibold uppercase text-[#05073C] border-[1px] border-primary/80">
                <tr>
                  {indexed && (
  ...
  return (
    <div className="w-inline-block h-10 w-10 ">
      <Image
        ...
        style={{ "maxinlineSize": "100%", "maxblock-size": "100%" }}
      />
      <Modal
        width={800}
        open={image}
