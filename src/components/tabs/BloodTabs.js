        ...
        <>
            ...
            <div className="p-4 mb-[70px]">
                {activeTab === 'Info' && (
                    <div>
                        {data.bloodBankAdditionalInfo !== null && <> <h3 className="font-bold text-lg text-black-600">{data.bloodBankAdditionalInfo.title}</h3>
                            ...
                            {data.bloodBankAdditionalInfo.imageUrl !== null && data.bloodBankAdditionalInfo.imageUrl !== "" && <img src={image_base_endpoint + data.bloodBankAdditionalInfo.imageUrl}></img>}
                        </>}
                ...
                {activeTab === 'Review' && (
                    ...
                    <ReviewList reviews={data.bloodBankReview} averageRating={data.averageRating} totalRatings={data.totalRating}></ReviewList>
