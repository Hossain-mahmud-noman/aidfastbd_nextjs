        ...
        <>
            ...
            <div className="p-4 mb-[70px]">
                {activeTab === 'Info' && (
                    <div>
                        {data.pharmacyAdditionalInfo !== null && <> <h3 className="font-bold text-lg text-black-600">{data.pharmacyAdditionalInfo.title}</h3>
                            ...
                            <img src={image_base_endpoint + data.pharmacyAdditionalInfo.imageUrl}></img></>}
                ...
                {activeTab === 'Review' && (
                    ...
                    <ReviewList reviews={data.pharmacyReview} averageRating={data.averageRating} totalRatings={data.totalRating}></ReviewList>
