         ...
         <div className="flex items-center flex-col md:flex-row xl:gap-[72px] lg:gap-12 gap-5">
            ...
            <div className="w-full">
               ...
               <div className="mt-7 md:mt-8 lg:mt-10 xl:mt-12 flex items-center gap-3 md:gap-4 xl:gap-10">
                  ...
                  <Link href="tel: 01980445424" className="group bg-white border-2 border-primary px-6 py-3 rounded-[12px] description2 hover:bg-blue-700 transition-all duration-300 flex items-center justify-center gap-2">
