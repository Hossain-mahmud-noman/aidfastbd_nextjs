...
const FAQ = () => {
   ...
   const data = [
      ...
      {
         key: "faq_3",
         question: i18n.t("AidFast কি পুরো বাংলাদেশে কাজ করে?"),
         answer: i18n.t("হুম। এখন সম্পুর্ন সিলেট বিভাগ, ব্রাহ্মণবাড়িয়া, ফরিদপুর ও ময়মনসিংহ বিভাগের কিছু জেলাসহ ১০ এর অধিক জেলায় AidFast এর সেবা বিস্তৃত রয়েছে। ২০২৫ সালের মধ্যেই সারা বাংলাদেশের সকল ডাক্তার ও স্বাস্থ্যসেবা প্রতিষ্ঠান AidFast অ্যাপ এ অন্তর্ভুক্ত হবে।")
      },
      {
         key: "faq_4",
         question: i18n.t("এই অ্যাপ কি ফ্রি?"),
         answer: i18n.t("হ্যাঁ! ইউজারদের জন্য AidFast অ্যাপ একদম ফ্রি। আপনি Google Play Store থেকে সহজেই ডাউনলোড করে নিতে পারবেন। Aidfast মোবাইল অ্যাপ ব্যবহার আরো সহজ ও স্মার্ট। অ্যাপ ডাউনলোড করতে ক্লিক করুন। অ্যাপ ডাউনলোড লিংক: https://play.google.com/store/apps/details?id=com.aidfastbd.app")
      },
      {
         key: "faq_5",
         question: i18n.t("AidFast ব্যবহার করা কি নিরাপদ?"),
         answer: i18n.t("হ্যাঁ। আপনার কোনো ব্যক্তিগত তথ্য ছাড়া এই অ্যাপ কাজ করে। এটা শুধু তথ্য খুঁজে পেতে সাহায্য করে। নিরাপদভাবে ব্যবহার করতে পারবেন।")
      },
      {
         key: "faq_6",
      ...
      {
         key: "faq_8",
         question: i18n.t("কোনো সমস্যায় পড়লে আমি কার সঙ্গে যোগাযোগ করবো?"),
         answer: i18n.t("আপনি আমাদের ফেসবুক পেইজে ইনবক্স করতে পারেন, অথবা ওয়েবসাইটে থাকা Contact Number / WhatsApp নাম্বারে সরাসরি কল দিতে পারেন। অথবা মেইল করতে পারেন। এছাড়াও ওয়েবসাইটের নিচের অংশে থাকা ফর্মটি পূরণ করেও যোগাযোগ করতে পারেন। জরুরি স্বাস্থ্যসেবা খুজতে চাইলে আমাদের অ্যাপ ও ওয়েবসাইটের মাধ্যমে জরুরি হেল্পলাইন নাম্বারে সরাসরি কল করতে পারেন। Helpline number :01338988734")
      },
      {
         key: "faq_9",
      ...
      {
         key: "faq_11",
         question: i18n.t("AidFast অ্যাপে রেজিস্ট্রেশন না করেও ব্যবহার করা যায়?"),
         answer: i18n.t("হ্যাঁ। আপনি রেজিস্ট্রেশন না করেও ডাক্তারের নাম, হাসপাতালের ঠিকানা, ফোন নম্বর, সিরিয়াল টাইম, রক্তদাতার তথ্যসহ অনেক কিছু দেখতে পারবেন।")
      },
      {
         key: "faq_12",
      ...
      {
         key: "faq_13",
         question: i18n.t("AidFast-এ দেওয়া তথ্যগুলো কতটা সত্যি?"),
         answer: i18n.t("আমাদের Aidfast রেজিষ্ট্রেশন টিম এর তত্তাবধানে সরাসরি যাচাই করে তথ্য এপ্রুভ করা হয়। প্রতিষ্ঠানগুলো নিজেই নিজেদের প্রোফাইলের সকল তথ্য আপডেট করতে পারেন। তাই তথ্যগুলো নির্ভরযোগ্য ও আপটুডেট।")
      },
      {
         key: "faq_14",
      ...
      {
         key: "faq_15",
         question: i18n.t("AidFast অ্যাপে কি নার্সিং হোম, ডেন্টাল ক্লিনিক বা চক্ষু ক্লিনিকও আছে?"),
         answer: i18n.t("হ্যাঁ! আপনি AidFast অ্যাপে বিভিন্ন ধরণের ক্লিনিক, নার্সিং হোম, ডেন্টাল কেয়ার ও চক্ষু সেন্টারের তথ্যও পাবেন।")
      },
      {
         key: "faq_16",
         question: i18n.t("AidFast-এর অফিস কোথায়?"),
         answer: i18n.t("প্রধান অফিস ৩০, ইব্রাহিমপুর, কাফরুল ঢাকা ১২০৬।")
      },
      {
         key: "faq_17",
         question: i18n.t("AidFast অ্যাপ ব্যবহার করতে কি ইন্টারনেট লাগবে?"),
         answer: i18n.t("হ্যাঁ। সাধারণভাবে মোবাইলে ইন্টারনেট সংযোগ থাকলেই আপনি অ্যাপটি ব্যবহার করতে পারবেন। ইন্টারনেট খরচ খুবই কম।")
      },
      {
         key: "faq_18",
      ...
      {
         key: "faq_20",
         question: i18n.t("AidFast অ্যাপ কিভাবে জীবন বাঁচাতে পারে?"),
         answer: i18n.t("জরুরি রক্তের প্রয়োজন, হার্ট অ্যাটাক, দুর্ঘটনা কিংবা প্রসবকালীন সময়ে সময়মতো তথ্য ও সেবা না পাওয়ার কারণে অনেক জীবন ঝুঁকিতে পড়ে। AidFast তাৎক্ষণিকভাবে কাছাকাছি রক্তদাতা, অ্যাম্বুলেন্স বা হাসপাতালের তথ্য দিয়ে সময়মতো সহায়তা নিশ্চিত করে।")
      }
   ];
