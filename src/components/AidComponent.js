        ...
        <div className="bg-gray-100 p-4 flex flex-col items-center">
            ...
            <div className="w-full mb-4">
                    ...
                    <div className='w-full ml-2 bg-blue[600]'>
                        ...
                        >
                            <Link href={"/diagnostic"}>
                                <div>
                                    <h3 className=" font-semi text-gray-700">Diagnostic Center & Hospital</h3>
                        ...
                        >
                            <Link href={"/blood"} className='h-full'>
                                ...
                                <p className="font-semi text-gray-700">{"Blood Bank & Donor Club"}</p>
                            </Link>
                ...
                >
                    <Link href={"/dental"}>
                        <div className="mb-3">
                            <img src={"/images/dental.png"} alt={"Dentals"} className="w-[45px] h-[35px] object-contain" />
                        </div>
            ...
            <Link className="bg-red-100 text-red-600 text-xl font-semibold w-full py-4 border-2 border-red-500 rounded-lg hover:bg-red-500 hover:text-white transition duration-300 text-center" href={"/emergency"}>
                Emergency
            </Link>
