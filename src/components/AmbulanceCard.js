    ...
    <Link href={"/ambulance/" + data?.userId}>
      ...
      >
        <div className="flex-1 pl-3 pt-3 pr-3 pb-1">
          ...
          <h3 className="text-sm md:text-md xl:text-lg mt-2 text-black mb-1 line-clamp-3">
            {data?.name}
          </h3>
