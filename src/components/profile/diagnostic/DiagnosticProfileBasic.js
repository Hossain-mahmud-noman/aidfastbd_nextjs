...
function DiagnosticProfileBasic({ data, token, user }) {
  ...
  const [formData, setFormData] = useState({
    diagnosticCenterEnglish: "",
    diagnosticCenterBangla: "",
    location: "",
    emergencyContact: "",
    registrationNo: "",
    serviceTime: "",
  ...
  useEffect(() => {
    if (data) {
      ...
      setFormData({
        diagnosticCenterEnglish: data.name || "",
        diagnosticCenterBangla: data.nameBn || "",
      ...
      setICUStatus(data.isOTAvailable);
      setOTStatus(data.isICUAvailable);
    }
  }, [data]);
  ...
  const handleSubmit = async () => {
    try {
      ...
      form.append('Name', formData.diagnosticCenterEnglish);
      form.append('NameBn', formData.diagnosticCenterBangla);
      ...
      form.append('IsICUAvailable', icuStatus === "true");
      form.append('IsOTAvailable', otStatus === "true");
  ...
  return (
    <div className="bg-white shadow-md rounded-lg w-full max-w-lg p-6">
      ...
      <InputField
        required
        label="Diagnostic Center or Hospital Name (English)"
        placeholder="Diagnostic/Hospital Name"
        value={formData.diagnosticCenterEnglish}
        onChange={handleInputChange}
        name="diagnosticCenterEnglish"
      />

      <InputField
        required
        label="Diagnostic Center or Hospital Name (Bangla)"
        placeholder="Diagnostic/Hospital Name Bangla"
        value={formData.diagnosticCenterBangla}
        onChange={handleInputChange}
        name="diagnosticCenterBangla"
      />
      ...
      <Dropdown
        ...
        value={icuStatus}
        onChange={(e) => setICUStatus(e.target.value)}
      />
...
export default DiagnosticProfileBasic;
