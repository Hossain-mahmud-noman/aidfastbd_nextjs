...
function HearingCareProfileInfo({ data, user, token, id, getProfileData }) {
  ...
  const handleSubmit = async () => {
    ...
    const payload = { "userId": user?.userId, "title": title, "imgList": simplifiedData, "details": details, "serviceType": 4, "id": id };
    try {
      const response = await fetch(
...
export default HearingCareProfileInfo