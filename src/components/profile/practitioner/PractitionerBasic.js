...
function PractitionerBasic({ data, token, user, getProfileData }) {
  ...
  return (
    <div className="bg-white shadow-custom-light rounded-lg w-full max-w-3xl mx-auto p-6">
      ...
      <InputField
        required
        label="General Practitioner Name (English)"
      ...
      <InputField
        required
        label="General Practitioner Name (Bangla)"
        placeholder="General Practitioner Name Bangla"
      ...
      <div className="mb-4 border">
        <label className="block text-sm font-medium text-gray-700 mb-2">Select General Practitioner Map Location</label>
        <MapComponent
          lat={latitude}
          lon={longitude}
...
export default PractitionerBasic