...
export default function DrugProfileServices({ data, token, genericServiceId, userId, getProfileData }) {
      ...
      {isModalOpen ? (
        ...
        <>
          <div className="flex justify-between items-center mb-6">
            <h2 className="text-xl font-semibold text-gray-800">Drug De Addiction Services</h2>
            <button
