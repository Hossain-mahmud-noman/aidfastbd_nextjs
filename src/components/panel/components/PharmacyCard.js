  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.put(
        `${panel_base}/pharmacy/${serviceData.id}/meta-update`,
        {
  ...
  return (
    <div>
      ...
      {serviceData.slug && <div
        onClick={() => {
          window.open("https://aidfastbd.com/pharmacy/d/" + serviceData.slug, "_blank");
        }}
        ...
        <div className="fixed inset-0 bg-gray-500 bg-opacity-50 flex justify-center items-start z-50">
          ...
          >
            <div className="flex justify-between items-center mb-4">
              <h2 className="text-xl font-semibold">Edit  Diagnostic Details</h2>
              <button
                type="button"
