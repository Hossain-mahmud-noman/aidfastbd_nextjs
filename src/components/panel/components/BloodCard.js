...
export default function  BloodCard({ service, onSave }) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.put(
        `${panel_base}/blood/${serviceData.id}/meta-update`,
        {
  ...
  return (
    <div>
      ...
      {serviceData.slug &&  <div
        onClick={() => {
          window.open("https://aidfastbd.com/blood/d/" +serviceData.slug, "_blank");
        }}
